...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Set_Opp_Stage_to_APP_Rejected</fullName>
        <field>StageName</field>
        <literalValue>APP: Rejected</literalValue>
        <name>Set Opp Stage to APP: Rejected</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <targetObject>SBQQ__Opportunity__c</targetObject>
    ...
    <fieldUpdates>
        ...
        <field>StageName</field>
        <literalValue>Establish Value</literalValue>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>Opp_Stage__c = &quot;CA: Review&quot;</formula>
    ...
    <rules>
        ...
        <description>Sets the Defaults to be used by the Quote</description>
    ...
    <rules>
        ...
        <actions>
            <name>Set_Opp_Record_Type_to_Renewals</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Update_Opp_Stage_to_APP_Approved</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        ...
        <actions>
            <name>Change_Opp_Status_to_rejected</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Quote_Set_Record_Type_to_B_Approvals</name>
        ...
        <description>workflow rule runs when the Quotes Status is set to Rejected</description>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>Set Contract Signed %28Temp Changed to CA%3A Review%29</fullName>
        <actions>
        ...
        <description>Update the Opportunity Stage to Contract Signed when a Contract has been signed through Docusign</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
</Workflow>
