...
&amp; TEXT(YEAR(CloseDate)) &amp; &quot; Renewal&quot;</formula>
    ...
    <fieldUpdates>
        <fullName>Opportunity_Update_Stage_to_Rejected</fullName>
        <field>StageName</field>
        <literalValue>APP: Rejected</literalValue>
        <name>Opportunity - Update Stage to Rejected</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
...
&quot;&quot;)</formula>
    ...
    <fieldUpdates>
        <fullName>Update_Contract_Stage_to_CA_Review</fullName>
        <field>StageName</field>
        <literalValue>CA: Review</literalValue>
        <name>Update Contract Stage to CA: Review</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
...
[NOTICE - Ed changed the field value from Document Approved to TB so I could deactivate the Document Approved Opportunity Record Type]</description>
    ...
    <fieldUpdates>
        <fullName>Update_Opp_Passed_To_Softrax_Flag</fullName>
        <field>Passed_to_Softrax__c</field>
        <literalValue>1</literalValue>
        <name>Update Opp Passed To Softrax Flag</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
    </fieldUpdates>
    ...
    <rules>
        ...
        <actions>
            <name>Update_Contract_Stage_to_CA_Review</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
    ...
    <rules>
        ...
        <criteriaItems>
            <field>Opportunity.StageName</field>
            <operation>notEqual</operation>
            <value>Contacted,Qualified,Trial,Needs Analysis Completed,Demo,Closed Won,Closed Lost,Voided</value>
        </criteriaItems>
        <criteriaItems>
    ...
    <rules>
        <fullName>Has Stage Changed to CA%3A Review from Closed Won</fullName>
        <actions>
            <name>Update_Stage_to_Closed_Won</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>AND( ISPICKVAL(PRIORVALUE( StageName ), &quot;Closed Won&quot;), ISPICKVAL(StageName, &quot;CA: Review&quot;))</formula>
    ...
    <rules>
        <fullName>Quote Rejected Changed</fullName>
        <actions>
            <name>Opportunity_Update_Record_Type_to_R</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>Opportunity_Update_Stage_to_Rejected</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>ISCHANGED( Number_of_quotes_that_are_Rejected__c ) &amp;&amp; Number_of_quotes_that_are_Rejected__c &gt; 0</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
